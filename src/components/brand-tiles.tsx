      ...
      {brands.map((brand) => (
        <li key={brand.value} className="min-w-0">
          <Link
            ...
            className="flex flex-col items-center gap-1 rounded-[8px] border border-gv-border bg-gv-card p-1.5 transition-colors duration-150 hover:border-gv-border-strong hover:bg-gv-soft"
          >
