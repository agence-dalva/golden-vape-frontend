    ...
    <>
      ...
      <div className="mb-6 flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <h2 className="mt-2 font-display text-[28px] font-normal leading-[1.2] text-gv-text">
        ...
        <div className="flex flex-col gap-12">
          {visibleGroups.map(([letter, list]) => (
            <section key={letter} aria-labelledby={`brands-${letter}`} id={`letter-${letter}`} className="scroll-mt-28">
              <h3
                id={`brands-${letter}`}
                className="mb-4 flex items-center gap-4 font-display text-2xl font-normal text-gv-text"
              >
                {letter}
